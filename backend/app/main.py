...
def _sanitize_pydantic_errors(errors: Any) -> list[Dict[str, Any]]:
    ...
    for e in errors:
        ...
        if "input" in e:
            try:
                # Best effort to keep it small and serializable
                val = e.get("input")
        ...
        if isinstance(ctx, dict):
            ...
            for k, v in ctx.items():
                # Convert anything non-primitive to string
...
async def validation_exception_handler(request: Request, exc: RequestValidationError):
    # Sanitize to avoid TypeError: Object of type ValueError is not JSON serializable
...
from app.routers.upload_file import router as upload_router  # noqa: E402
from app.routers.prompt_template import router as prompt_template_router  # noqa: E402
