...
const AiChat: React.FC = () => {
  ...
  const handleBoostMode = useCallback(
    ...
    [addMessage, selectedRoleId, safeProjectId, streamText, renderSupplementary]
  );
  ...
  const handleSingleModel = useCallback(
    ...
    [provider, selectedRoleId, safeProjectId, addMessage, streamText]
  );
    ...
    async (file: File): Promise<string | null> => {
      ...
      try {
        ...
        try {
          ...
          setInput(injected);
          return injected; // ✅ now returning a string
        } catch (jsonError) {
