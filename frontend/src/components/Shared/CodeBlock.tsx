...
const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  const toastHideTimer = React.useRef<number | null>(null);
  ...
  const langRaw =
    ...
    null;
  const prismLang = toPrismLang(langRaw) || "markdown";
  ...
  const header = fileNameProp || (langRaw ? langRaw.toUpperCase() : "CODE");
